...
class CategoryBarChart extends StatefulWidget {
  const CategoryBarChart({Key? key, required this.title}) : super(key: key);
...
class BarChartState extends State<CategoryBarChart> {
  ...
  Future<List<ExpenseData>> getChartData() async {
    ...
    ExpenseList.add(ExpenseData("Average American", 8419)); // average
